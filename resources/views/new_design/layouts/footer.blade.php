<footer class="footer footer-dark">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        <img src="new_design/images/logo-footer.png" class="footer-logo" alt="Footer Logo" width="105"
                             height="25">
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="footer-copyright">Copyright © {{ now()->year }} Moderno MK. All Rights Reserved. | Powered by
                ipetrovski</p><!-- End .footer-copyright -->
        </div><!-- End .container -->
            ...
            <div class="row no-gutters bg-white newsletter-popup-content">
                <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                    <div class="banner-content text-center">
                        <img src="new_design/images/popup/newsletter/logo.png" class="logo" alt="logo" width="60"
                             height="15">
                ...
                <div class="col-xl-2-5col col-lg-5 ">
                    <img src="new_design/images/popup/newsletter/img-1.jpg" class="newsletter-img" alt="newsletter">
                </div>
            </div>
        </div>
    </div>
