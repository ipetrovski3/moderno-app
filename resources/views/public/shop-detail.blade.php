                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="{{ asset('/storage/products/' . $product->image) }}" alt="First slide"> </div>
                        </div>
                    </div>
                </div>
						...
						<ul>
							<li>
								<div class="form-group quantity-box">
									...
									<input class="form-control" id="qty" data-product="{{ $product->id  }}"  value="0" min="0" max="20" type="number">
								</div>
							</li>
						</ul>
