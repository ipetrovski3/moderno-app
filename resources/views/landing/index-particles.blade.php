        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <div class="col-eight home-content__text pull-right">
                    ...
                    на нашата <br> веб страна.
                    </h1>

                    <p>
                    За сите корисници кои ќе се регистрираат на нашиот сајт следат голем број изненадувања!
                    Внесете ја Вашата емаил адреса во формата подоле и очекувајте изненадување!
                    </p>

                    <div class="home-content__subscribe">
                        <form id="mc-form" class="group" novalidate="true">
                            <input type="email" value="" name="EMAIL" class="email" id="mc-email" placeholder="Email Address" required="">
                            <input type="submit" name="subscribe" value="Извести ме">
